...
at deployment. TIAE instead learns a deployable conditional action law
...
demonstrated action, but TIAE never treats endpoint type itself as an
equivalence label.
...
**Actor-disabled CEM.** Disable all TIAE action heads and run the original CEM
