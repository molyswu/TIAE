...
The public [`paper-e5-goal-v1`](https://huggingface.co/molyswu/TIAE/tree/paper-e5-goal-v1)
...
| `waypoint_tiae` | Waypoint TIAE | Direct | 71.22 | 99.00 | 58.22 | 77.22 | 76.42 |
| `goal_tiae` | Goal-displacement TIAE | Direct | **80.22** | **99.56** | **95.67** | **82.11** | **89.39** |
...
These are Goal-displacement TIAE official Direct SR values. Each training-seed cell averages 100
...
[`paper-e5-goal-v1`](https://huggingface.co/molyswu/TIAE/tree/paper-e5-goal-v1)
