...
This page records the public artifact boundary for TIAE. The status table in
...
- all 72 paper checkpoint shards under the immutable public Hugging Face
  revision [`paper-e5-goal-v1`](https://huggingface.co/molyswu/TIAE/tree/paper-e5-goal-v1).
