...
| TIAE Actor | four-slot，hidden 1024，depth 3，dropout 0 |
...
- **任务专属**：Forward Predictor、Action Embedder、Prediction Projector、TIAE Actor；
...
```bash
python train.py --config-name=tiae_goal \
