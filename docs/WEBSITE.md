# TIAE Project Website

The public project website is served from this directory at
<https://molyswu.github.io/TIAE/>. The repository publishes the paper story,
...
reads `assets/goal-tiae-alignment.json` to remain sharp and inspectable at
...
The desktop header presents the four research affiliations beside TIAE, while
...
3. verify <https://molyswu.github.io/TIAE/> after the job completes.
