"""TIAE: a JEPA-based world model with a shared intent-to-action operator.

The JEPA class is a forward world model with a deployable local/goal intent
action law. When used with topology-preserving losses from tiae.py, it forms
the full TIAE (Topological Intent-Action Embedding) framework.
"""
