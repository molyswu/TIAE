...
def test_all_paper_configs_compose():
    expected = {
        ...
        "tiae_inverse": ("inverse", 0.1, 0.0, "four_slot"),
        "tiae_goal_only": ("goal_only", 0.0, 0.05, "four_slot"),
        "tiae_goal": ("displacement", 0.1, 0.05, "four_slot"),
        "tiae_waypoint": ("waypoint", 0.1, 0.05, "four_slot"),
    }
