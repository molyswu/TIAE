#!/usr/bin/env python3
"""Build the permanent QR code for the TIAE Community landing page."""
...
COMMUNITY_URL = "https://molyswu.github.io/TIAE/community/"


def main() -> None:
    root = Path(__file__).resolve().parents[1]
    destination = root / "docs/assets/tiae-community-page-qr.png"
