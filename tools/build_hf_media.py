#!/usr/bin/env python3
"""Build and verify high-resolution editions of the TIAE project films."""
...
EDITIONS = {
    "page": ("tiae-hero-film.mp4", "tiae-hero-film", False),
    "share": ("tiae-project-film-share.mp4", "tiae-project-film-share", True),
}
